...
1. multipass launch 24.04 --name k8s-master --cpus 2 --memory 4G --disk 20G

2. multipass shell k8s-master
...
1. multipass launch 24.04 --name k8s-worker --cpus 2 --memory 4G --disk 20G

2.  multipass shell k8s-worker
